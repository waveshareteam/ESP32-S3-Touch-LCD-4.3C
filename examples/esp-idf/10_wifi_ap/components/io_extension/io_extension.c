...
void IO_EXTENSION_Init()
{
    ...
    IO_EXTENSION.Last_io_value = 0xF7; // All pins are initially set to high (output mode)
    IO_EXTENSION.Last_od_value = 0xF7; // All pins are initially set to high (open-drain mode)
}
